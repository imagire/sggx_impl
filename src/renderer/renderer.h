...
{
	{ 
		{ { 0x1a, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0x1a, 0, 0, 0 }, { 0xff, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0x80, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0x80, 0, 0, 0 }, { 0xff, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, },
		{ { 0x1a, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0x1a, 0, 0, 0 }, { 0xff, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0x80, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0x80, 0, 0, 0 }, { 0xff, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, },
		{ { 0x1a, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0x1a, 0, 0, 0 }, { 0xff, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0x80, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0x80, 0, 0, 0 }, { 0xff, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, },
		{ { 0x1a, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0x1a, 0, 0, 0 }, { 0xff, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0x80, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0x80, 0, 0, 0 }, { 0xff, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, },
		{ { 0x1a, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0x1a, 0, 0, 0 }, { 0xff, 0xff, 0x1a, 0, 0, 0 }, { 0xff, 0x1a, 0xff, 0, 0, 0 }, { 0x1a, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0x80, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0x80, 0, 0, 0 }, { 0xff, 0xff, 0x80, 0, 0, 0 }, { 0xff, 0x80, 0xff, 0, 0, 0 }, { 0x80, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, { 0xff, 0xff, 0xff, 0, 0, 0 }, },
...
static inline bool intersect_volume(const Vec in, const Vec diff, Ray &o)
{
...
voxel_data |= 0xffffff;
	...
	Vec c = (L_d * phase_d * (1.0 - metalic) + L_d * phase_s * metalic) *
		sigma_s *
		exp(- t_in * l * density) * // 入射後の減衰
		(t_in * l / inscatter_probability);
...
Radiance ParticipatingEffect(Vec out, Vec in, Radiance backword, int depth, Random &rnd)
{
	...
	Ray o;
	if (!intersect_volume(x0, d, o)) return backword;// ボリュームと交差しませんでした。

	int id_sggx[3] = {
		(int)((double)SGGX_X * o.o.x),
		(int)((double)SGGX_Y * o.o.y),
		(int)((double)SGGX_Z * o.o.z),
	};
	// todo: assert でひっかけてはみたい
	if (id_sggx[0] < 0) id_sggx[0] = 0;
	if (id_sggx[1] < 0) id_sggx[1] = 0;
	if (id_sggx[2] < 0) id_sggx[2] = 0;
	if (SGGX_X <= id_sggx[0]) id_sggx[0] = SGGX_X - 1;
	if (SGGX_Y <= id_sggx[1]) id_sggx[1] = SGGX_Y - 1;
	if (SGGX_Z <= id_sggx[2]) id_sggx[2] = SGGX_Z - 1;
